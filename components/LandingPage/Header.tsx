...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full transition-all duration-300 ${scrolled ? 'bg-white shadow-lg py-2' : 'bg-[#8089ff] py-4'
        }`}
    >
      <div className="max-w-[1140px] mx-auto px-6">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            <a
              href="#"
              className={`flex items-center ${scrolled ? 'text-gray-600' : 'text-white'
                } hover:text-gray-900`}
            >
          ...
          <div className="hidden md:block">
            <a
              ...
              className={`${scrolled ? 'bg-white text-blue-600' : 'bg-blue-600 text-white'
                } px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 cursor-pointer`}
            >
              Login
            </a>
          </div>
        ...
        {menuOpen && (
          <nav className="md:hidden mt-4">
            <a
              href="#"
              className={`block py-2 ${scrolled ? 'text-gray-600' : 'text-white'
                } hover:text-gray-900`}
            >
            ...
            <a
              href="#"
              className={`block mt-4 ${scrolled ? 'bg-white text-blue-600' : 'bg-blue-600 text-white'
                } px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 cursor-pointer`}
            >
              Login
            </a>
