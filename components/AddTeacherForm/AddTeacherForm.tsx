...
const AddTeacherForm = (props) => {
    ...
    return (
        <Modal opened={Boolean(store.addTeacherModalState.show)} onClose={() => { dispatch(setAddTeacherModalState({ show: false })); close() }} title={"Add teacher"} >
            <Paper radius="md" p="xl" withBorder {...props}>
                ...
                <Stack>
                    ...
                    <form onSubmit={form.onSubmit(() => { dispatch(setAddTeacherModalState({ show: false })); router.push('/dashboard/teachers') })}>
                        <TextInput
                            required
                            label="Name"
