...
const AddParentForm = (props) => {
    ...
    return (
        <Modal opened={Boolean(store.addParentModalState.show)} onClose={() => { dispatch(setAddClassModalState({ show: false })); close() }} title={"Add parent"} >
            <Paper radius="md" p="xl" withBorder {...props}>
                ...
                <Stack>
                    ...
                    <form onSubmit={form.onSubmit(() => { dispatch(setAddClassModalState({ show: false })); router.push('/dashboard/teachers') })}>
                        <TextInput
                            required
                            label="Name"
